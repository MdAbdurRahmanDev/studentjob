    ...
    <div class="min-h-[calc(100vh-200px)] bg-[#faf9f6] flex items-center justify-center py-12 px-6">
        <div class="bg-white rounded-3xl shadow-xl shadow-gray-200/50 overflow-hidden w-full max-w-md p-10">
            ...
            <div class="mb-8 text-center">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-2">ফোন নম্বর ভেরিফিকেশন</h3>
                <p class="text-gray-500 text-sm">অ্যাকাউন্ট তৈরি সম্পন্ন করতে আপনার ফোন নম্বরে পাঠানো ৪ ডিজিটের কোডটি দিন।</p>
            </div>
            ...
            <form method="POST" action="{{ route('register.verify.post') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    @error('phone') <span class="mt-2 text-sm text-red-600 block text-center">{{ $message }}</span> @enderror
                </div>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('register') }}" class="text-sm text-gray-500 hover:text-gray-900 transition-colors">
