...
new class extends Component
{
    ...
    public function submit()
    {
        ...
        $frontPath = $this->front_image->store('verifications', 'uploads');
        $backPath = $this->document_type === 'nid' && $this->back_image ? $this->back_image->store('verifications', 'uploads') : null;
